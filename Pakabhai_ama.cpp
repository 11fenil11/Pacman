...
//void ghost(int &x,int &y,int &gx,int &gy)
//{	
//	//left-Rigth or Up-Down check karava mate
//	if(abs(gx-x)>abs(gy-y))
//	{
//		//ghost e pacman ni right side che so ghost ne left side move karvanu che
//		if((gx-x)>0)
//		{
//
////			if(getpixel(gx-18,gy)==2 || getpixel(gx-18,gy+18)==2 || getpixel(gx-18,gy-18)==2)
////			if(getpixel(gx-18,gy+18)==2 || getpixel(gx-18,gy-18)==2)
...
//				{
//					gx=gx+1;
//					gy=gy-1;	//jyare right side na _|- shape ma - wada bhag ni niche ave che tyare bi ene upar lai jay che etle diwal fodi nakhe che.  
//				}	
//				else
//				{
//					gx=gx+1;
...
////			if(getpixel(gx+18,gy)==2 || getpixel(gx+18,gy+18)==2 || getpixel(gx+18,gy-18)==2)
////			if(getpixel(gx+18,gy+18)==2 || getpixel(gx+18,gy-18)==2)
////			if(getpixel(gx+18,gy)==2 || getpixel(gx+18,gy-18)==2 ||getpixel(gx+18,gy+18)==2 || getpixel(gx,gy+18)==2 || getpixel(gx,gy-18)==2 || getpixel(gx-18,gy)==2 || getpixel(gx-18,gy-18)==2 || getpixel(gx-18,gy+18)==2) 
//			if(getpixel(gx+19,gy)==2 || getpixel(gx+19,gy-19)==2 ||getpixel(gx+19,gy+19)==2 || getpixel(gx,gy+19)==2 || getpixel(gx,gy-19)==2 || getpixel(gx-19,gy)==2 || getpixel(gx-19,gy-19)==2 || getpixel(gx-19,gy+19)==2) 
//			{
//				if((gy-y)>0)
//				{
